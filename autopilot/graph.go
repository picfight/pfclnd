...
func (d *databaseChannelGraph) addRandChannel(node1, node2 *pfcec.PublicKey,
	capacity pfcutil.Amount) (*ChannelEdge, *ChannelEdge, error) {

	fetchNode := func(pub *pfcec.PublicKey) (*channeldb.LightningNode, error) {
		if pub != nil {
	...
	var lnNode1, lnNode2 *pfcec.PublicKey
...
func (d *databaseChannelGraph) addRandNode() (*pfcec.PublicKey, error) {
	nodeKey, err := randKey()
	if err != nil {
		return nil, err
	}
...
func randKey() (*pfcec.PublicKey, error) {
...
// meant to aide in the generation of random graphs for use within test cases
// the exercise the autopilot package.
func (m *memChannelGraph) addRandChannel(node1, node2 *pfcec.PublicKey,
	capacity pfcutil.Amount) (*ChannelEdge, *ChannelEdge, error) {
...
func (m *memChannelGraph) addRandNode() (*pfcec.PublicKey, error) {
	newPub, err := randKey()
	if err != nil {
		return nil, err
	}
