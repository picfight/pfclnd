...
func (h *HeuristicConstraints) availableChans(channels []Channel,
	funds pfcutil.Amount) (pfcutil.Amount, uint32) {
	...
	var totalChanAllocation pfcutil.Amount
	...
	targetAllocation := pfcutil.Amount(float64(totalFunds) * h.Allocation)
