...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/pfclnd/chainntnfs)
...
implementation of the `ChainNotifier` interface depends on `pfcd`.

## Installation and Updating

```bash
$ go get -u github.com/picfight/pfclnd/chainntnfs
```
