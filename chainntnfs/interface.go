...
// targeted events on the Picfightcoin blockchain. The interface specification is
// intentionally general in order to support a wide array of chain notification
// implementations such as: pfcd's websockets notifications, Picfightcoin Core's
// ZeroMQ notifications, various Picfightcoin API services, Electrum servers, etc.
//
...
type ChainConn interface {
	...
	GetBlockHeaderVerbose(blockHash *chainhash.Hash) (
		*pfcjson.GetBlockHeaderVerboseResult, error)
