...
// txUpdate encapsulates a transaction related notification sent from pfcd to
...
// PfcdNotifier implements the ChainNotifier interface using pfcd's websockets
...
// Ensure PfcdNotifier implements the ChainNotifier interface at compile time.
var _ chainntnfs.ChainNotifier = (*PfcdNotifier)(nil)

// New returns a new PfcdNotifier instance. This function assumes the pfcd node
// detailed in the passed configuration is already running, and willing to
// accept new websockets clients.
func New(config *rpcclient.ConnConfig, spendHintCache chainntnfs.SpendHintCache,
	confirmHintCache chainntnfs.ConfirmHintCache) (*PfcdNotifier, error) {

	notifier := &PfcdNotifier{
	...
	// Disable connecting to pfcd within the rpcclient.New method. We
...
// Start connects to the running pfcd node over websockets, registers for block
...
func (b *PfcdNotifier) Start() error {
	...
	// Connect to pfcd, and register for notifications on connected, and
	// disconnected blocks.
...
// Stop shutsdown the PfcdNotifier.
func (b *PfcdNotifier) Stop() error {
	...
	// Shutdown the rpc client, this gracefully disconnects from pfcd, and
...
func (b *PfcdNotifier) onBlockConnected(hash *chainhash.Hash, height int32, t time.Time) {
...
func (b *PfcdNotifier) onBlockDisconnected(hash *chainhash.Hash, height int32, t time.Time) {
	// Append this new chain update to the end of the queue of new chain
	// updates.
	b.chainUpdates.ChanIn() <- &chainUpdate{
		blockHash:   hash,
...
func (b *PfcdNotifier) onRedeemingTx(tx *pfcutil.Tx, details *pfcjson.BlockDetails) {
...
func (b *PfcdNotifier) notificationDispatcher() {
out:
	for {
		select {
...
func (b *PfcdNotifier) historicalConfDetails(txid *chainhash.Hash,
...
func (b *PfcdNotifier) confDetailsFromTxIndex(txid *chainhash.Hash,
...
func (b *PfcdNotifier) confDetailsManually(txid *chainhash.Hash, startHeight,
...
// them.
func (b *PfcdNotifier) handleBlockConnected(epoch chainntnfs.BlockEpoch) error {
...
func (b *PfcdNotifier) notifyBlockEpochs(newHeight int32, newSha *chainhash.Hash) {
...
func (b *PfcdNotifier) notifyBlockEpochClient(epochClient *blockEpochRegistration,
...
func (b *PfcdNotifier) RegisterSpendNtfn(outpoint *wire.OutPoint,
...
// RegisterConfirmationsNtfn registers a notification with PfcdNotifier
// which will be triggered once the txid reaches numConfs number of
// confirmations.
func (b *PfcdNotifier) RegisterConfirmationsNtfn(txid *chainhash.Hash, _ []byte,
...
// epochCancel is a message sent to the PfcdNotifier when a client wishes to
...
func (b *PfcdNotifier) RegisterBlockEpochNtfn(
