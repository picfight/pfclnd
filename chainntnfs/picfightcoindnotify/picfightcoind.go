...
// PicfightcoindNotifier implements the ChainNotifier interface using a picfightcoind
// chain client. Multiple concurrent clients are supported. All notifications
// are achieved via non-blocking sends on client channels.
type PicfightcoindNotifier struct {
	...
	chainConn *chain.PicfightcoindClient
...
// Ensure PicfightcoindNotifier implements the ChainNotifier interface at compile
// time.
var _ chainntnfs.ChainNotifier = (*PicfightcoindNotifier)(nil)

// New returns a new PicfightcoindNotifier instance. This function assumes the
// picfightcoind node  detailed in the passed configuration is already running, and
// willing to accept RPC requests and new zmq clients.
func New(chainConn *chain.PicfightcoindConn, spendHintCache chainntnfs.SpendHintCache,
	confirmHintCache chainntnfs.ConfirmHintCache) *PicfightcoindNotifier {

	notifier := &PicfightcoindNotifier{
	...
	notifier.chainConn = chainConn.NewPicfightcoindClient()

	return notifier
}

// Start connects to the running picfightcoind node over websockets, registers for
// block notifications, and finally launches all related helper goroutines.
func (b *PicfightcoindNotifier) Start() error {
	// Already started?
	if atomic.AddInt32(&b.started, 1) != 1 {
		return nil
	}

	// Connect to picfightcoind, and register for notifications on connected,
...
// Stop shutsdown the PicfightcoindNotifier.
func (b *PicfightcoindNotifier) Stop() error {
	// Already shutting down?
	if atomic.AddInt32(&b.stopped, 1) != 1 {
		return nil
	}

	// Shutdown the rpc client, this gracefully disconnects from picfightcoind,
...
func (b *PicfightcoindNotifier) notificationDispatcher() {
out:
	for {
		select {
...
func (b *PicfightcoindNotifier) historicalConfDetails(txid *chainhash.Hash,
...
func (b *PicfightcoindNotifier) confDetailsFromTxIndex(txid *chainhash.Hash,
...
func (b *PicfightcoindNotifier) confDetailsManually(txid *chainhash.Hash,
...
func (b *PicfightcoindNotifier) handleBlockConnected(block chainntnfs.BlockEpoch) error {
	...
	txns := pfcutil.NewBlock(rawBlock).Transactions()
...
func (b *PicfightcoindNotifier) notifyBlockEpochs(newHeight int32, newSha *chainhash.Hash) {
...
func (b *PicfightcoindNotifier) notifyBlockEpochClient(epochClient *blockEpochRegistration,
...
func (b *PicfightcoindNotifier) RegisterSpendNtfn(outpoint *wire.OutPoint,
...
func (b *PicfightcoindNotifier) dispatchSpendDetailsManually(
...
// RegisterConfirmationsNtfn registers a notification with PicfightcoindNotifier
// which will be triggered once the txid reaches numConfs number of
// confirmations.
func (b *PicfightcoindNotifier) RegisterConfirmationsNtfn(txid *chainhash.Hash,
...
// epochCancel is a message sent to the PicfightcoindNotifier when a client wishes
...
func (b *PicfightcoindNotifier) RegisterBlockEpochNtfn(
