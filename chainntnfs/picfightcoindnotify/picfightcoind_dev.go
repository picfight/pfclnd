...
// picfightcoind notifier to ensure we drain all notifications up to syncHeight,
...
func (b *PicfightcoindNotifier) UnsafeStart(bestHeight int32, bestHash *chainhash.Hash,
