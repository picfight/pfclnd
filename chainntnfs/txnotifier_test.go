...
func TestTxNotifierFutureConfDispatch(t *testing.T) {
	...
	block1 := pfcutil.NewBlock(&wire.MsgBlock{
	...
	block2 := pfcutil.NewBlock(&wire.MsgBlock{
...
func TestTxNotifierConfReorg(t *testing.T) {
	...
	block3 := pfcutil.NewBlock(&wire.MsgBlock{
		Transactions: []*wire.MsgTx{&tx2, &tx3},
	})
	block4 := pfcutil.NewBlock(&wire.MsgBlock{})
...
func TestTxNotifierSpendReorg(t *testing.T) {
	...
	emptyBlock := pfcutil.NewBlock(&wire.MsgBlock{})
	err = n.ConnectTip(
