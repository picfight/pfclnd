...
type channelCloser struct {
	...
	lastFeeProposal pfcutil.Amount
	...
	priorFeeOffers map[pfcutil.Amount]*lnwire.ClosingSigned
...
func newChannelCloser(cfg chanCloseCfg, deliveryScript []byte,
	...
	return &channelCloser{
		...
		priorFeeOffers:      make(map[pfcutil.Amount]*lnwire.ClosingSigned),
	}
}
...
func (c *channelCloser) proposeCloseSigned(fee pfcutil.Amount) (*lnwire.ClosingSigned, error) {
...
func feeInAcceptableRange(localFee, remoteFee pfcutil.Amount) bool {
...
// offered fee.
func rachetFee(fee pfcutil.Amount, up bool) pfcutil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint,
	ourIdealFee, lastSentFee, remoteFee pfcutil.Amount) pfcutil.Amount {
