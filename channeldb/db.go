...
func (d *DB) FetchOpenChannels(nodeID *pfcec.PublicKey) ([]*OpenChannel, error) {
...
func (d *DB) fetchOpenChannels(tx *bbolt.Tx,
	nodeID *pfcec.PublicKey) ([]*OpenChannel, error) {
...
func (d *DB) pruneLinkNode(tx *bbolt.Tx, remotePub *pfcec.PublicKey) error {
