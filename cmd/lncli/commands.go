...
var sendCoinsCommand = cli.Command{
	Name:      "sendcoins",
	Category:  "On-chain",
	Usage:     "Send picfightcoin on-chain to an address.",
	ArgsUsage: "addr amt",
	Description: `
	Send amt coins in satoshis to the BASE58 encoded picfightcoin address addr.
	...
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:  "addr",
			Usage: "the BASE58 encoded picfightcoin address to send coins to on-chain",
		},
		// TODO(roasbeef): switch to PFC on command line? int may not be sufficient
		cli.Int64Flag{
			Name:  "amt",
			Usage: "the number of picfightcoin denominated in satoshis to send",
		},
		cli.Int64Flag{
			Name: "conf_target",
...
var sendManyCommand = cli.Command{
	Name:      "sendmany",
	Category:  "On-chain",
	Usage:     "Send picfightcoin on-chain to multiple addresses.",
