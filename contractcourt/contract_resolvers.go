...
// able to carry out the necessary steps required to fully resolve a Picfightcoin
...
func (h *htlcOutgoingContestResolver) Resolve() (ContractResolver, error) {
	...
	//
	// Source:
	// https://github.com/picfight/pfcd/blob/991d32e72fe84d5fbf9c47cd604d793a0cd3a072/blockchain/validate.go#L154
