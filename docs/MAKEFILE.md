...
- Compilation and installation of `pfcd` and `btcctl`.
...
that the [`github.com/picfight/pfcd`][pfcd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/picfight/pfcd`][pfcd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/picfight/pfcd`][pfcd] specified
...
`itest`
-------
Installs the version of [`github.com/picfight/pfcd`][pfcd] specified in
...
Equivalent to [`lint`](#lint) [`dep`](#dep) [`pfcd`](#pfcd)
[`unit-race`](#unit-race).
...
[pfcd]: https://github.com/picfight/pfcd (github.com/picfight/pfcd")
