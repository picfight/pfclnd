...
var (
	...
	alicePrivKey, alicePubKey = pfcec.PrivKeyFromBytes(pfcec.S256(),
		alicePrivKeyBytes[:])
	...
	bobPrivKey, bobPubKey = pfcec.PrivKeyFromBytes(pfcec.S256(),
		bobPrivKeyBytes[:])
...
func (n *testNode) IdentityKey() *pfcec.PublicKey {
...
func createTestFundingManager(t *testing.T, privKey *pfcec.PrivateKey,
	...
	f, err := newFundingManager(fundingConfig{
		...
		RequiredRemoteDelay: func(amt pfcutil.Amount) uint16 {
			return 4
		},
	...
	f.cfg.NotifyWhenOnline = func(peer *pfcec.PublicKey,
...
func openChannel(t *testing.T, alice, bob *testNode, localFundingAmt,
	pushAmt pfcutil.Amount, numConfs uint32,
...
func assertNumPendingReservations(t *testing.T, node *testNode,
	peerPubKey *pfcec.PublicKey, expectedNum int) {
...
func TestFundingManagerRestartBehavior(t *testing.T) {
	...
	alice.fundingMgr.cfg.NotifyWhenOnline = func(peer *pfcec.PublicKey,
...
func TestFundingManagerOfflinePeer(t *testing.T) {
	...
	peerChan := make(chan *pfcec.PublicKey, 1)
