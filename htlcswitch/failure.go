...
type ErrorEncrypterExtracter func(*pfcec.PublicKey) (ErrorEncrypter,
	lnwire.FailCode)
...
func (s *SphinxErrorEncrypter) Decode(r io.Reader) error {
	...
	var err error
	s.EphemeralKey, err = pfcec.ParsePubKey(ephemeral[:], pfcec.S256())
	if err != nil {
		return err
	}
