...
const (
	// PicfightcoinHop denotes that an HTLC is to be forwarded along the Picfightcoin
	// link with the specified short channel ID.
	PicfightcoinHop NetworkHop = iota
...
// returned.
func (p *OnionProcessor) ExtractErrorEncrypter(ephemeralKey *pfcec.PublicKey) (
