...
func (s *Switch) htlcForwarder() {
	...
	var (
		...
		totalSatSent    pfcutil.Amount
		totalSatRecv    pfcutil.Amount
	)
	...
	for {
		...
		case <-s.cfg.LogEventTicker.Ticks():
			...
			var (
				...
				newSatSent    pfcutil.Amount
				newSatRecv    pfcutil.Amount
			)
			...
			var (
				...
				diffSatSent    pfcutil.Amount
				diffSatRecv    pfcutil.Amount
			)
