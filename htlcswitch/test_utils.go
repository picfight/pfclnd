...
var (
	...
	_, testPubKey = pfcec.PrivKeyFromBytes(pfcec.S256(), testPrivKey)
...
func createTestChannel(alicePrivKey, bobPrivKey []byte,
	aliceAmount, bobAmount, aliceReserve, bobReserve pfcutil.Amount,
	...
	aliceKeyPriv, aliceKeyPub := pfcec.PrivKeyFromBytes(pfcec.S256(), alicePrivKey)
	bobKeyPriv, bobKeyPub := pfcec.PrivKeyFromBytes(pfcec.S256(), bobPrivKey)
...
func createClusterChannels(aliceToBob, bobToCarol pfcutil.Amount) (
