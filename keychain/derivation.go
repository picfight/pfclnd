...
import "github.com/picfight/pfcd/pfcec"
...
type SecretKeyRing interface {
	...
	DerivePrivKey(keyDesc KeyDescriptor) (*pfcec.PrivateKey, error)
	...
	ScalarMult(keyDesc KeyDescriptor, pubKey *pfcec.PublicKey) ([]byte, error)
}
