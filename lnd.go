...
import (
	...
	"github.com/picfight/pfclnd/walletunlocker"
)
...
func lndMain() error {
	...
	var network string
	switch {
	case cfg.Picfightcoin.TestNet3 || cfg.Litecoin.TestNet3:
		network = "testnet"

	case cfg.Picfightcoin.MainNet || cfg.Litecoin.MainNet:
		network = "mainnet"

	case cfg.Picfightcoin.SimNet:
		network = "simnet"

	case cfg.Picfightcoin.RegTest:
		network = "regtest"
	}
...
// real PKI.
//
// This function is adapted from https://github.com/picfight/pfcd and
// https://github.com/picfight/pfcutil
