...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/picfight/pfclnd/lnrpc)
...
description):
  ...
  * WalletBalance
     * Returns the wallet's current confirmed balance in PFC.
  * ChannelBalance
     * Returns the daemons' available aggregate channel balance in PFC.
  * GetTransactions
...
```bash
$ go get -u github.com/picfight/pfclnd/lnrpc
```
...
5. Run [`gen_protos.sh`](https://github.com/picfight/pfclnd/blob/master/lnrpc/gen_protos.sh) to generate new protobuf definitions.
