...
func (c *commitment) toDiskCommit(ourCommit bool) *channeldb.ChannelCommitment {
	...
	commit := &channeldb.ChannelCommitment{
		...
		CommitFee:       c.fee,
		FeePerKw:        pfcutil.Amount(c.feePerKw),
		CommitTx:        c.txn,
		CommitSig:       c.sig,
...
func (lc *LightningChannel) diskCommitToMemCommit(isLocal bool,
	...
	remoteCommitPoint *pfcec.PublicKey) (*commitment, error) {
...
type CommitmentKeyRing struct {
	...
	NoDelayKey *pfcec.PublicKey

	// RevocationKey is the key that can be used by the other party to
	// redeem outputs from a revoked commitment transaction if it were to
	// be published.
	RevocationKey *pfcec.PublicKey
}
...
func deriveCommitmentKeys(commitPoint *pfcec.PublicKey, isOurCommit bool,
	...
	var (
		delayBasePoint      *pfcec.PublicKey
		noDelayBasePoint    *pfcec.PublicKey
		revocationBasePoint *pfcec.PublicKey
	)
	if isOurCommit {
...
type LightningChannel struct {
	...
	LocalFundingKey *pfcec.PublicKey
	...
	// channel.
	RemoteFundingKey *pfcec.PublicKey
...
func (lc *LightningChannel) logUpdateToPayDesc(logUpdate *channeldb.LogUpdate,
	...
	remoteDustLimit pfcutil.Amount) (*PaymentDescriptor, error) {
...
func NewBreachRetribution(chanState *channeldb.OpenChannel, stateNum uint64,
	...
	commitmentSecret, commitmentPoint := pfcec.PrivKeyFromBytes(
		pfcec.S256(), revocationPreimage[:],
	)
...
func htlcTimeoutFee(feePerKw SatPerKWeight) pfcutil.Amount {
	return feePerKw.FeeForWeight(HtlcTimeoutWeight)
}

// htlcSuccessFee returns the fee in satoshis required for an HTLC success
// transaction based on the current fee rate.
func htlcSuccessFee(feePerKw SatPerKWeight) pfcutil.Amount {
...
func htlcIsDust(incoming, ourCommit bool, feePerKw SatPerKWeight,
	htlcAmt, dustLimit pfcutil.Amount) bool {
...
func (lc *LightningChannel) createCommitmentTx(c *commitment,
	...
	var (
		delay                      uint32
		delayBalance, p2wkhBalance pfcutil.Amount
	)
	if c.isOurs {
	...
	var totalOut pfcutil.Amount
	for _, txOut := range commitTx.TxOut {
		totalOut += pfcutil.Amount(txOut.Value)
	}
...
func (lc *LightningChannel) ProcessChanSyncMsg(
	...
	// is valid.
	var commitPoint *pfcec.PublicKey
	switch {
...
// new commitment.
func (lc *LightningChannel) NextRevocationKey() (*pfcec.PublicKey, error) {
	lc.RLock()
	defer lc.RUnlock()
...
// any new states.
func (lc *LightningChannel) InitNextRevocation(revKey *pfcec.PublicKey) error {
	lc.Lock()
	defer lc.Unlock()
...
func NewUnilateralCloseSummary(chanState *channeldb.OpenChannel, signer Signer,
	...
	remoteCommit channeldb.ChannelCommitment,
	commitPoint *pfcec.PublicKey) (*UnilateralCloseSummary, error) {
	...
	closeSummary := channeldb.ChannelCloseSummary{
		...
		SettledBalance:          pfcutil.Amount(localBalance),
...
func newOutgoingHtlcResolution(signer Signer, localChanCfg *channeldb.ChannelConfig,
	...
	feePerKw SatPerKWeight, dustLimit pfcutil.Amount, csvDelay uint32, localCommit bool,
...
func newIncomingHtlcResolution(signer Signer, localChanCfg *channeldb.ChannelConfig,
	commitHash chainhash.Hash, htlc *channeldb.HTLC, keyRing *CommitmentKeyRing,
	feePerKw SatPerKWeight, dustLimit pfcutil.Amount, csvDelay uint32,
...
func (lc *LightningChannel) CreateCloseProposal(proposedFee pfcutil.Amount,
	localDeliveryScript []byte,
	remoteDeliveryScript []byte) ([]byte, *chainhash.Hash, pfcutil.Amount, error) {
...
func (lc *LightningChannel) CompleteCooperativeClose(localSig, remoteSig []byte,
	...
	proposedFee pfcutil.Amount) (*wire.MsgTx, pfcutil.Amount, error) {
...
func CreateCommitTx(fundingOutput wire.TxIn,
	...
	amountToSelf, amountToThem, dustLimit pfcutil.Amount) (*wire.MsgTx, error) {
...
func CreateCooperativeCloseTx(fundingTxIn wire.TxIn,
	localDust, remoteDust, ourBalance, theirBalance pfcutil.Amount,
...
// fee rate (fee-per-kw).
func (lc *LightningChannel) CalcFee(feeRate SatPerKWeight) pfcutil.Amount {
	return feeRate.FeeForWeight(CommitWeight)
}

// RemoteNextRevocation returns the channelState's RemoteNextRevocation.
func (lc *LightningChannel) RemoteNextRevocation() *pfcec.PublicKey {
	lc.RLock()
	defer lc.RUnlock()
...
func (lc *LightningChannel) LocalChanReserve() pfcutil.Amount {
