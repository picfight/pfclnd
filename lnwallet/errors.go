...
func ErrChanReserveTooSmall(reserve, dustLimit pfcutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve pfcutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize pfcutil.Amount) ReservationError {
	return ReservationError{
