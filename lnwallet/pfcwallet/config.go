...
var (
	lnwalletHomeDir = pfcutil.AppDataDir("lnwallet", false)
	...
	pfcdHomedirCAFile  = filepath.Join(pfcdHomeDir, "rpc.cert")
...
type Config struct {
	...
	// PrivatePass is the private password to the underlying pfcwallet
	// instance. Without this, the wallet cannot be decrypted and operated.
	PrivatePass []byte

	// PublicPass is the optional public password to pfcwallet. This is
