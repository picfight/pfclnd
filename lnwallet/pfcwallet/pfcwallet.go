...
import (
	...
	base "github.com/picfight/pfcwallet/wallet"
...
var (
	...
	// stored within the top-level waleltdb buckets of pfcwallet.
...
// backed by an active instance of pfcwallet. At the time of the writing of
// this documentation, this implementation requires a full pfcd node to
// operate.
type BtcWallet struct {
	// wallet is an active instance of pfcwallet.
	wallet *base.Wallet
...
func (b *BtcWallet) Start() error {
	...
	// Start the underlying pfcwallet core.
	b.wallet.Start()
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) ConfirmedBalance(confs int32) (pfcutil.Amount, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) NewAddress(t lnwallet.AddressType, change bool) (pfcutil.Address, error) {
...
//
// This is a part of the WalletController interface.
func (b *BtcWallet) IsOurAddress(a pfcutil.Address) bool {
	result, err := b.wallet.HaveAddress(a)
	return result && (err == nil)
}

// SendOutputs funds, signs, and broadcasts a Picfightcoin transaction paying out to
...
func (b *BtcWallet) SendOutputs(outputs []*wire.TxOut,
	...
	// SendOutputs.
	feeSatPerKB := pfcutil.Amount(feeRate.FeePerKVByte())
...
func (b *BtcWallet) ListUnspentWitness(minConfs, maxConfs int32) (
	...
	for _, output := range unspentOutputs {
		...
		if txscript.IsPayToWitnessPubKeyHash(pkScript) {
			...
			// the pfcwallet service does not include it.
		...
		if addressType == lnwallet.WitnessPubKey ||
			...
			// PFC to satoshis.
			amt, err := pfcutil.NewAmount(output.Amount)
			if err != nil {
				return nil, err
			}
...
// finally broadcasts the passed transaction to the Picfightcoin network. If
	...
	if err := b.wallet.PublishTransaction(tx); err != nil {
		...
		case *chain.RPCClient:
			if strings.Contains(err.Error(), "already have") {
				...
				// the behaviour of picfightcoind, which will not
...
func minedTransactionsToDetails(
	...
	for _, tx := range block.Transactions {
		...
		var destAddresses []pfcutil.Address
