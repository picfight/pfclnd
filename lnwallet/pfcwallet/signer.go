...
func (b *BtcWallet) fetchPrivKey(keyDesc *keychain.KeyDescriptor) (*pfcec.PrivateKey, error) {
	...
	hash160 := pfcutil.Hash160(keyDesc.PubKey.SerializeCompressed())
	addr, err := pfcutil.NewAddressWitnessPubKeyHash(hash160, b.netParams)
	if err != nil {
		return nil, err
	}
...
func maybeTweakPrivKey(signDesc *lnwallet.SignDescriptor,
	privKey *pfcec.PrivateKey) (*pfcec.PrivateKey, error) {

	var retPriv *pfcec.PrivateKey
	switch {
...
func (b *BtcWallet) ComputeInputScript(tx *wire.MsgTx,
	...
	case pka.AddrType() == waddrmgr.NestedWitnessPubKey:
		...
		p2wkhAddr, err := pfcutil.NewAddressWitnessPubKeyHash(pubKeyHash,
			b.netParams)
		if err != nil {
			return nil, err
		}
...
func (b *BtcWallet) SignMessage(pubKey *pfcec.PublicKey,
