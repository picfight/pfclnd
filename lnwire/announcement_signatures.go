...
type AnnounceSignatures struct {
	...
	// node pub key and creating the reference node_key -> picfightcoin_key.
	NodeSignature Sig

	// PicfightcoinSignature is the signature which contains the signed node
	// public key, by this signature we proof that we possess of the
	// picfightcoin key and and creating the reverse reference picfightcoin_key ->
	// node_key.
	PicfightcoinSignature Sig
