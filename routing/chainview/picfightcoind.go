...
// PicfightcoindFilteredChainView is an implementation of the FilteredChainView
// interface which is backed by picfightcoind.
type PicfightcoindFilteredChainView struct {
	...
	// TODO: Factor out common logic between picfightcoind and pfcd into a
	// NodeFilteredView interface.
	chainClient *chain.PicfightcoindClient
...
// A compile time check to ensure PicfightcoindFilteredChainView implements the
// chainview.FilteredChainView.
var _ FilteredChainView = (*PicfightcoindFilteredChainView)(nil)

// NewPicfightcoindFilteredChainView creates a new instance of a FilteredChainView
// from RPC credentials and a ZMQ socket address for a picfightcoind instance.
func NewPicfightcoindFilteredChainView(
	chainConn *chain.PicfightcoindConn) *PicfightcoindFilteredChainView {

	chainView := &PicfightcoindFilteredChainView{
	...
	chainView.chainClient = chainConn.NewPicfightcoindClient()
...
func (b *PicfightcoindFilteredChainView) Start() error {
	// Already started?
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *PicfightcoindFilteredChainView) Stop() error {
	// Already shutting down?
	if atomic.AddInt32(&b.stopped, 1) != 1 {
		return nil
	}

	// Shutdown the rpc client, this gracefully disconnects from picfightcoind's
...
func (b *PicfightcoindFilteredChainView) onFilteredBlockConnected(height int32,
...
func (b *PicfightcoindFilteredChainView) onFilteredBlockDisconnected(height int32,
	hash chainhash.Hash) {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *PicfightcoindFilteredChainView) FilterBlock(blockHash *chainhash.Hash) (*FilteredBlock, error) {
	req := &filterBlockReq{
		blockHash: blockHash,
...
func (b *PicfightcoindFilteredChainView) chainFilterer() {
	defer b.wg.Done()
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *PicfightcoindFilteredChainView) UpdateFilter(ops []channeldb.EdgePoint,
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *PicfightcoindFilteredChainView) FilteredBlocks() <-chan *FilteredBlock {
...
//
// NOTE: This is part of the FilteredChainView interface.
func (b *PicfightcoindFilteredChainView) DisconnectedBlocks() <-chan *FilteredBlock {
