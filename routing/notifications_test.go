...
var (
	...
	priv1, _    = pfcec.NewPrivateKey(pfcec.S256())
	bitcoinKey1 = priv1.PubKey()

	priv2, _    = pfcec.NewPrivateKey(pfcec.S256())
...
func createChannelEdge(ctx *testCtx, picfightcoinKey1, picfightcoinKey2 []byte,
	chanValue pfcutil.Amount, fundingHeight uint32) (*wire.MsgTx, *wire.OutPoint,
