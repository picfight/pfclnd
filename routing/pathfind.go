...
// Vertex is a simple alias for the serialization of a compressed Picfightcoin
// public key.
type Vertex [33]byte

// NewVertex returns a new Vertex given a public key.
func NewVertex(pub *pfcec.PublicKey) Vertex {
	var v Vertex
...
func findPath(g *graphParams, r *restrictParams,
	sourceNode *channeldb.LightningNode, target *pfcec.PublicKey,
...
func findPaths(tx *bbolt.Tx, graph *channeldb.ChannelGraph,
	source *channeldb.LightningNode, target *pfcec.PublicKey,
