...
type testCtx struct {
	...
	aliases map[string]*pfcec.PublicKey
...
func TestAddProof(t *testing.T) {
	...
	fundingTx, _, chanID, err := createChannelEdge(ctx,
		bitcoinKey1.SerializeCompressed(), picfightcoinKey2.SerializeCompressed(),
		100, 0)
	if err != nil {
	...
	copy(edge.PicfightcoinKey1Bytes[:], picfightcoinKey1.SerializeCompressed())
	copy(edge.PicfightcoinKey2Bytes[:], picfightcoinKey2.SerializeCompressed())
...
func TestAddEdgeUnknownVertexes(t *testing.T) {
	...
	edge := &channeldb.ChannelEdgeInfo{
		...
		NodeKey1Bytes:         pub1,
		NodeKey2Bytes:         pub2,
		PicfightcoinKey1Bytes: pub1,
		PicfightcoinKey2Bytes: pub2,
		AuthProof:             nil,
	}
	if err := ctx.router.AddEdge(edge); err != nil {
	...
	var (
		pubKey1 *pfcec.PublicKey
		pubKey2 *pfcec.PublicKey
	)
	...
	copy(edge.PicfightcoinKey1Bytes[:], node1Bytes)
	copy(edge.PicfightcoinKey2Bytes[:], node2Bytes)
...
func TestWakeUpOnStaleBranch(t *testing.T) {
	...
	copy(edge1.PicfightcoinKey1Bytes[:], picfightcoinKey1.SerializeCompressed())
	copy(edge1.PicfightcoinKey2Bytes[:], picfightcoinKey2.SerializeCompressed())
	...
	copy(edge2.PicfightcoinKey1Bytes[:], picfightcoinKey1.SerializeCompressed())
	copy(edge2.PicfightcoinKey2Bytes[:], picfightcoinKey2.SerializeCompressed())
...
func TestDisconnectedBlocks(t *testing.T) {
	...
	edge1 := &channeldb.ChannelEdgeInfo{
		...
		NodeKey1Bytes:         node1.PubKeyBytes,
		NodeKey2Bytes:         node2.PubKeyBytes,
		PicfightcoinKey1Bytes: node1.PubKeyBytes,
		PicfightcoinKey2Bytes: node2.PubKeyBytes,
		AuthProof: &channeldb.ChannelAuthProof{
			NodeSig1Bytes:         testSig.Serialize(),
			NodeSig2Bytes:         testSig.Serialize(),
			PicfightcoinSig1Bytes: testSig.Serialize(),
