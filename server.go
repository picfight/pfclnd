...
import (
	...
	"github.com/picfight/pfclnd/autopilot"
	"github.com/picfight/pfclnd/brontide"
	"github.com/picfight/pfclnd/channeldb"
	"github.com/picfight/pfclnd/contractcourt"
	"github.com/picfight/pfclnd/discovery"
	...
	"github.com/picfight/pfclnd/nat"
	"github.com/picfight/pfclnd/routing"
	"github.com/picfight/pfclnd/sweep"
...
func noiseDial(idPriv *pfcec.PrivateKey) func(net.Addr) (net.Conn, error) {
...
func newServer(listenAddrs []net.Addr, chanDB *channeldb.DB, cc *chainControl,
	privKey *pfcec.PrivateKey) (*server, error) {
	...
	if cfg.DebugHTLC {
		kiloCoin := pfcutil.Amount(pfcutil.SatoshiPerPicfightcoin * 1000)
	...
	s.authGossiper, err = discovery.New(discovery.Config{
		...
		FindPeer: func(pub *pfcec.PublicKey) (lnpeer.Peer, error) {
	...
	// Select the configuration and furnding parameters for Picfightcoin or
	// Litecoin, depending on the primary registered chain.
	primaryChain := registeredChains.PrimaryChain()
	chainCfg := cfg.Picfightcoin
	...
	s.fundingMgr, err = newFundingManager(fundingConfig{
		...
		Notifier:           cc.chainNotifier,
		FeeEstimator:       cc.feeEstimator,
		SignMessage: func(pubKey *pfcec.PublicKey,
		...
		NumRequiredConfs: func(chanAmt pfcutil.Amount,
		...
		RequiredRemoteDelay: func(chanAmt pfcutil.Amount) uint16 {
			...
			delay := uint16(pfcutil.Amount(maxRemoteDelay) *
		...
		RequiredRemoteChanReserve: func(chanAmt,
			dustLimit pfcutil.Amount) pfcutil.Amount {
		...
		RequiredRemoteMaxValue: func(chanAmt pfcutil.Amount) lnwire.MilliSatoshi {
		...
		RequiredRemoteMaxHTLCs: func(chanAmt pfcutil.Amount) uint16 {
		...
		MinChanSize:           pfcutil.Amount(cfg.MinChanSize),
	})
	if err != nil {
		return nil, err
	}
...
func (s *server) Start() error {
	...
	if !cfg.NoNetBootstrap && !(cfg.Picfightcoin.SimNet || cfg.Litecoin.SimNet) &&
...
//
// NOTE: This function is safe for concurrent access.
func (s *server) SendToPeer(target *pfcec.PublicKey,
	msgs ...lnwire.Message) error {
...
//
// NOTE: This function is safe for concurrent access.
func (s *server) NotifyWhenOnline(peerKey *pfcec.PublicKey,
...
//
// NOTE: This function is safe for concurrent access.
func (s *server) FindPeer(peerKey *pfcec.PublicKey) (*peer, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
// dropped.
func shouldDropLocalConnection(local, remote *pfcec.PublicKey) bool {
...
type openChanReq struct {
	targetPubkey *pfcec.PublicKey

	chainHash chainhash.Hash

	localFundingAmt  pfcutil.Amount
	remoteFundingAmt pfcutil.Amount
...
//
// NOTE: This function is safe for concurrent access.
func (s *server) DisconnectPeer(pubKey *pfcec.PublicKey) error {
...
func (s *server) fetchNodeAdvertisedAddr(pub *pfcec.PublicKey) (net.Addr, error) {
