...
// channels, or regular Picfightcoin transactions.
...
type contractMaturityReport struct {
	...
	// contract.
	limboBalance pfcutil.Amount

	// recoveredBalance is the total value that has been successfully swept
	// back to the user's wallet.
	recoveredBalance pfcutil.Amount

	// localAmount is the local value of the commitment output.
	localAmount pfcutil.Amount
...
func (k *kidOutput) Decode(r io.Reader) error {
	...
	k.amt = pfcutil.Amount(byteOrder.Uint64(scratch[:]))
