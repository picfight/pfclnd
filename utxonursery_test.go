...
var (
	...
	// Dummy timeout tx used to test serialization, borrowed from pfcd
	// msgtx_test
...
func init() {
	...
	for i := range signDescriptors {
		pk, err := pfcec.ParsePubKey(keys[i], pfcec.S256())
		if err != nil {
...
func assertNurseryReport(t *testing.T, nursery *utxoNursery,
	...
	expectedLimboBalance pfcutil.Amount) {
