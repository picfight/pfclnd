...
func (s *SessionInfo) ComputeSweepOutputs(totalAmt pfcutil.Amount,
	txVSize int64) (pfcutil.Amount, pfcutil.Amount, error) {
	...
	rewardAmt := (totalAmt*pfcutil.Amount(s.RewardRate) + 999999) / 1000000
