...
import (
	...
	"github.com/picfight/pfclnd/watchtower/wtserver"
	"github.com/picfight/pfclnd/watchtower/wtwire"
	"github.com/picfight/pfcutil"
)

// addr is the server's reward address given to watchtower clients.
var addr, _ = pfcutil.DecodeAddress(
...
func randPubKey(t *testing.T) *pfcec.PublicKey {
	t.Helper()

	sk, err := pfcec.NewPrivateKey(pfcec.S256())
	if err != nil {
...
func initServer(t *testing.T, db wtserver.DB,
	...
	s, err := wtserver.New(&wtserver.Config{
		...
		NewAddress: func() (pfcutil.Address, error) {
			return addr, nil
		},
	})
	if err != nil {
