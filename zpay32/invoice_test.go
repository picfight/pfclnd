...
var (
	testMillisat24PFC    = lnwire.MilliSatoshi(2400000000000)
	testMillisat2500uPFC = lnwire.MilliSatoshi(250000000)
	testMillisat20mPFC   = lnwire.MilliSatoshi(2000000000)
	...
	testPrivKey, testPubKey = pfcec.PrivKeyFromBytes(pfcec.S256(), testPrivKeyBytes)
	...
	testAddrTestnet, _       = pfcutil.DecodeAddress("mk2QpYatsKicvFVuTAQLBryyccRXMUaGHP", &chaincfg.TestNet3Params)
	testRustyAddr, _         = pfcutil.DecodeAddress("1RustyRX2oai4EYYDpQGWvEL62BBGqN9T", &chaincfg.MainNetParams)
	testAddrMainnetP2SH, _   = pfcutil.DecodeAddress("3EktnHQD7RiAE6uzMj2ZifT9YgRrkSgzQX", &chaincfg.MainNetParams)
	testAddrMainnetP2WPKH, _ = pfcutil.DecodeAddress("bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4", &chaincfg.MainNetParams)
	testAddrMainnetP2WSH, _  = pfcutil.DecodeAddress("bc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qccfmv3", &chaincfg.MainNetParams)

	testHopHintPubkeyBytes1, _ = hex.DecodeString("029e03a901b85534ff1e92c43c74431f7ce72046060fcf7a95c37e148f78c77255")
	testHopHintPubkey1, _      = pfcec.ParsePubKey(testHopHintPubkeyBytes1, pfcec.S256())
	testHopHintPubkeyBytes2, _ = hex.DecodeString("039e03a901b85534ff1e92c43c74431f7ce72046060fcf7a95c37e148f78c77255")
	testHopHintPubkey2, _      = pfcec.ParsePubKey(testHopHintPubkeyBytes2, pfcec.S256())
	...
	testMessageSigner = MessageSigner{
		SignCompact: func(hash []byte) ([]byte, error) {
			sig, err := pfcec.SignCompact(pfcec.S256(),
...
func TestDecodeEncode(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// Please send 0.0025 PFC for a cup of nonsense (ナンセンス 1杯) to the same peer, within 1 minute
		...
		{
			// Send 2500uPFC for a cup of coffee with a custom CLTV
			// expiry value.
...
func comparePubkeys(a, b *pfcec.PublicKey) bool {
	if a == b {
		return true
	}
	if a == nil && b != nil {
